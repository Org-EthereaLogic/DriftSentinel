...
[![Codacy Badge](https://api.codacy.com/project/badge/Grade/0cafc81455f5467cb2d482741cf1a680)](https://app.codacy.com/gh/Org-EthereaLogic/DriftSentinel?utm_source=github.com&utm_medium=referral&utm_content=Org-EthereaLogic/DriftSentinel&utm_campaign=Badge_Grade)
...
| `tests/` | 297-test suite covering domain logic, packaging, and governance |
...
make test   # runs the 297-test suite
```
